    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            if (string1 != null) {
                out.println('1');
                string1.print();
                java.lang.String numberString = outBuffer.toString();
                out.print(numberString.substring(numberString.lastIndexOf('#') + 1));
            } else
                out.println('0');
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (line.equals("1")) {
                ...
                int countStringsBuffer = Solution.countStrings;
                Solution.countStrings = number - 1;
                string1 = new String();
                Solution.countStrings = countStringsBuffer;
            }
